package com.gmail.gradetskiy.homework3.homework4;
...
public class TotalSales {
    public static void main(String[] args) {
        ...
        double priceGalaxyS24 = 34999.00; // цена 1-го смартфона GalaxyS24
        double priceGalaxyS23 = 28999.00; // цена 1-го смартфона GalaxyS23
        double priceGalaxyS24Ultra = 52999.00; // цена 1-го смартфона GalaxyS24Ultra
        ...
        System.out.println("Средняя цена смартфонов проданных за "+ n +" дней равняется  = "+priceNDay+" EUR");
        System.out.println("Абсалютная  сумма от продажи смартфонов за " + n +" дней = "+sumEveryDaySmartphone+" EUR");
